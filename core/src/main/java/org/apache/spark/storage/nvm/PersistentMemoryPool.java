...
public class PersistentMemoryPool {
    ...
    PersistentMemoryPool(long pool_size) {
      pool_size = pool_size == -1 ? DEFAULT_PMPOOL_SIZE : pool_size;
      System.out.println("PersistentMemoryPool.nativeOpenDevice to be created");
      this.deviceHandler = nativeOpenDevice("", pool_size);
    }
